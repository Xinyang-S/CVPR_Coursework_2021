...
imgL = cv2.imread(r'D:\IC-Msc\Computer Vision\Original Picture\HG\DSCF0209.JPG', cv2.IMREAD_GRAYSCALE)  # left image
imgR = cv2.imread(r'D:\IC-Msc\Computer Vision\Original Picture\HG\DSCF0212.JPG', cv2.IMREAD_GRAYSCALE)  # right image
